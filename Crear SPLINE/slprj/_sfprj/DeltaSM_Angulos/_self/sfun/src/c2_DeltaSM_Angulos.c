  ...
  *chartInstance)
{
  ...
  if (CV_EML_IF(0, 1, 0, c2_time < c2_tf1 + c2_TIni)) {
    ...
    c2_PosZ = ((((c2_a10z + 0.0 * c2_tiempo) + 0.0 * c2_d_mpower(chartInstance,
      c2_tiempo)) + -50.0 * c2_mpower(chartInstance, c2_tiempo)) + 37.5 *
               c2_b_mpower(chartInstance, c2_tiempo)) + -7.5 * c2_c_mpower
    ...
    if (CV_EML_IF(0, 1, 1, c2_time < (c2_tf2 + c2_tf1) + c2_TIni)) {
      ...
      c2_PosY = ((((c2_a10x + 0.0 * c2_tiempo) + 0.0 * c2_d_mpower(chartInstance,
        c2_tiempo)) + 75.0 * c2_mpower(chartInstance, c2_tiempo)) + -56.25 *
                 c2_b_mpower(chartInstance, c2_tiempo)) + 11.25 * c2_c_mpower
        (chartInstance, c2_tiempo);
      ...
      if (CV_EML_IF(0, 1, 2, c2_time < ((c2_tf2 + c2_tf1) + c2_tf3) + c2_TIni))
      {
        ...
        c2_PosZ = ((((c2_a30z + 0.0 * c2_tiempo) + 0.0 * c2_d_mpower
                   ...
                   (chartInstance, c2_tiempo)) + 7.5 * c2_c_mpower(chartInstance,
          c2_tiempo);
      } else {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3746641845U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1511591418U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(943236927U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2713866527U);
}
...
mxArray *sf_c2_DeltaSM_Angulos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("d1T375thHEu0UfE1bvkibB");
...
static void mdlSetWorkWidths_c2_DeltaSM_Angulos(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2127303144U));
  ssSetChecksum1(S,(769397137U));
  ssSetChecksum2(S,(2532290080U));
  ssSetChecksum3(S,(2704335348U));
