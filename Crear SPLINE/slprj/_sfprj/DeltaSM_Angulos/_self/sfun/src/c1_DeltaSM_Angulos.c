  ...
  *chartInstance)
{
  ...
  for (c1_i0 = 0; c1_i0 < 3; c1_i0++) {
    c1_phi[c1_i0] = 1.5707963267948966 + 2.0943951023931953 * (real_T)c1_i0;
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1344465153U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2734187361U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3320936632U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1515889755U);
}
...
mxArray *sf_c1_DeltaSM_Angulos_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("uTpzOVhPG2F9uTiqCDXJkB");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,3157);
        _SFD_CV_INIT_EML_FOR(0,1,0,248,258,742);
...
static void mdlSetWorkWidths_c1_DeltaSM_Angulos(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(434410344U));
  ssSetChecksum1(S,(2371115349U));
  ssSetChecksum2(S,(357009688U));
  ssSetChecksum3(S,(1555254625U));
