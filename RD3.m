...
if strcmp(arch,'win64')
   [flag, topdir]=system('adams2015_1_SE_x64 -top');
else
   [flag, topdir]=system('adams2015_1_SE -top');
end
if flag == 0
  ...
  addpath( 'C:\MSC~1.SOF\ADAMS_~1\2015_1\controls/win64' ) ;
  addpath( 'C:\MSC~1.SOF\ADAMS_~1\2015_1\controls/win32' ) ;
  addpath( 'C:\MSC~1.SOF\ADAMS_~1\2015_1\controls/matlab' ) ;
  addpath( 'C:\MSC~1.SOF\ADAMS_~1\2015_1\controls/utils' ) ;
  ADAMS_sysdir = 'C:\MSC~1.SOF\ADAMS_~1\2015_1\' ;
end
ADAMS_exec = '' ;
ADAMS_host = 'Sebastian' ;
ADAMS_cwd ='C:\Users\Sebastian\Desktop\Tesis B\T_MSC_ADAMS'  ;
ADAMS_prefix = 'RD3' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'SetPG!SetPY!SetPR' ;
ADAMS_outputs = 'PosicionG!PosicionY!PosicionR!EF_X!EFE_Y!EF_Z' ;
ADAMS_pinput = 'RD3.ctrl_pinput' ;
ADAMS_poutput = 'RD3.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   1
                   8
                   9
